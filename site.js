...
const projects = [
  ...
  },
  {
    ...
    type: "e-shop",
    year: "2025",
    desc: "Custom Shopify Plus storefront for a Nordic outdoor brand. Custom checkout, multi-currency, product configurator.",
    stack: ["Shopify", "Hydrogen", "TypeScript", "Tailwind"],
    visual: "shop",
  },
  {
    title: "Mercure CMS",
    type: "web app",
    year: "2024",
    desc: "Headless CMS for a digital agency — multi-tenant, role-based, with a block editor and live preview across three frontends.",
    stack: ["Laravel", "Vue.js", "Postgres", "Redis"],
    visual: "editor",
  },
  {
    title: "Studio Voltaire",
    type: "website",
    year: "2024",
    desc: "Marketing site for an architecture studio. Lighthouse 100 across the board, GSAP-driven scroll chapters, headless Sanity CMS.",
    stack: ["Astro", "Svelte", "Sanity", "GSAP"],
    visual: "site",
  },
  {
    title: "Pulsefin",
    type: "web app",
    year: "2023",
    desc: "B2B invoicing & cashflow dashboard. Stripe integration, bank sync via Teller, forecasted runway charts, PDF generation.",
  ...
  },
  {
    ...
    type: "platform",
    year: "2023",
    desc: "Internal REST / GraphQL gateway for a logistics provider. Rate-limited, versioned, 99.98% uptime.",
